...
The independent Ubuntu image uses WineHQ `10.0.0.0~jammy-1`, including its
matching amd64 and i386 packages. It follows AndrewSav's verified sequence:
...
Final local image: `sha256:8fc2c29c17b42780a992cc56bb4e4730157dd599fc38c6e787015dd942205523`.
...
Wine 11 has not had a valid full comparison. The user's actual save is not
available on this host. The connection test uses a generated world under
`/opt/v-rising-test`, with game and mod updates frozen for the subsequent Wine
comparison. No image or commits have been published remotely.
